...
class NewsRepository (private val service: ApiService, private val dao: NewsDao):ApiService,NewsDao {



   // get all articles from api
    override suspend fun getArticlesNews(sourceName: String): NewsResponse =service.getArticlesNews(sourceName)
    ...
    override fun deleteAllArticle() =dao.deleteAllArticle()
